...
# --------------------------------------------------------
    ...
    st.caption(
        "The lesion-focused view uses the reference lesion region available for this representative BUS-BRA case. "
        "Grad-CAM indicates model attention and is not a definitive lesion segmentation."
    )
